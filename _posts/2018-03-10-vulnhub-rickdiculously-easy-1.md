...
![Arp-scan](./assets/rickdiculously-easy-1/1.png)

Then, quick nmap SYN scan to see which ports it has open.

![Nmap SYN scan](./assets/rickdiculously-easy-1/2.png)
...
![SC Nmap Scan](./assets/rickdiculously-easy-1/5.png)
...
![FTP connection](./assets/rickdiculously-easy-1/6.png)

I'm in. Now, I'll download the FLAG.txt file and check it locally.

![Check first flag](./assets/rickdiculously-easy-1/7.png)
...
![Nikto scan port 80](./assets/rickdiculously-easy-1/8.png)

Right. A '/passwords' directory in the wid. I'll access host/passwords in the browser:

![Explore /passwords directory](./assets/rickdiculously-easy-1/9.png)

Obviously, I open the file FLAG.txt and see this:

![Second FLAG.txt](./assets/rickdiculously-easy-1/10.png)

'FLAG{Yeah d- just don't do it}'. Another flag, 20 points.

I'll go to /passwords.html now:

![Check passwords.html file](./assets/rickdiculously-easy-1/11.png)

Rick was here! Let's check the source code:

![Source code of passwords.html](./assets/rickdiculously-easy-1/12.png)

Ok, a juicy piece of information. Password: winter. Maybe we can log in with ssh? 

![Password:winter](./assets/rickdiculously-easy-1/13.png)
...
![Access Zeus](./assets/rickdiculously-easy-1/14.png)
...
![Dirb brute force](./assets/rickdiculously-easy-1/15.png)

There is an interesting /robots.txt file. I'll check it in the browser. 

![Robots.txt file](./assets/rickdiculously-easy-1/16.png)
...
![Check .cgi](./assets/rickdiculously-easy-1/17.png)
...
![Enumerate a bit more, top ports using nmap](./assets/rickdiculously-easy-1/18.png)

They are running unknown services. I guess I can simply connect using netcat:

![Connecting using netcat](./assets/rickdiculously-easy-1/19.png)

A flag.

![Another flag using netcat](./assets/rickdiculously-easy-1/20.png)
...
![Traceroute.cgi](./assets/rickdiculously-easy-1/21.png)
...
![Try traceroute.cgi program](./assets/rickdiculously-easy-1/22.png)
...
![Command injection](./assets/rickdiculously-easy-1/23.png)
...
![Connect to ssh](./assets/rickdiculously-easy-1/27.png)

No luck with 'Morty' or 'RickSanchez', but with 'Summer':

![No luck trying](./assets/rickdiculously-easy-1/28.png)

I'm in. Time to explore the system from the inside!

![I'm in](./assets/rickdiculously-easy-1/29.png)
...
![Locate flag](./assets/rickdiculously-easy-1/30.png)
...
![Access other directories](./assets/rickdiculously-easy-1/31.png)
...
![Analyze files](./assets/rickdiculously-easy-1/32.png)

Now I've got the two files to analyze.

![Analyze files 2](./assets/rickdiculously-easy-1/33.png)
...
![Find message in image](./assets/rickdiculously-easy-1/34.png)

Nice, the password of the .zip file. I'll unzip it and...

![Unzip file](./assets/rickdiculously-easy-1/35.png)
...
![Obtain file from Rick](./assets/rickdiculously-easy-1/36.png)
...
![Copy file and execute it](./assets/rickdiculously-easy-1/37.png)
...
![Create list 1](./assets/rickdiculously-easy-1/38.png)
![Create list 2](./assets/rickdiculously-easy-1/39.png)
