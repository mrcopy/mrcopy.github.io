...
![Ping scan nmap](./assets/bulldog-1/2.png)
...
![Which services](./assets/bulldog-1/3.png)

Also, a UDP scan.

![UDP scan](./assets/bulldog-1/4.png)

I decide to check TCP port 80, so I go to the browser and check the page:

![Check TCP 80](./assets/bulldog-1/5.png)
...
![Hidden directory](./assets/bulldog-1/9.png)
...
![More gold](./assets/bulldog-1/10.png)
...
![Brute force 80](./assets/bulldog-1/11.png)
...
![Check /admin](./assets/bulldog-1/12.png)
...
![Piece of cake](./assets/bulldog-1/13.png)
...
![List of passwords](./assets/bulldog-1/14.png)
...
![Hash identifier](./assets/bulldog-1/15.png)

I have to use SHA-1 in hashcat, which is number 100. So the command is this:

![SHA-1 check](./assets/bulldog-1/16.png)
![SHA-2 check 2](./assets/bulldog-1/16-a.png)
...
![2 out of 7 passwords](./assets/bulldog-1/17.png)
...
![Access web shell](./assets/bulldog-1/20.png)
...
![Check users list](./assets/bulldog-1/25.png)
...
![Duplicate commands](./assets/bulldog-1/26.png)
...
![Reverse file](./assets/bulldog-1/33.png)
...
![Password hidden in strings](./assets/bulldog-1/34.png)
